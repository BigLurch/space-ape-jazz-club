...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo get_template_directory_uri(); ?>./assets/image/club-logo-32x32.png">
    <title><?php bloginfo('name') ?></title>
    
    <!-- Extern links -->
    <link rel="stylesheet" href="https://use.typekit.net/hkg7gdj.css">
    ...
    <div class="container">
        ...
        <header class="scroll-header">
            ...
            <div class="scroll-header__inner">
                ...
                <div class="scroll-header__content">
                    <a href="<?php echo 'http://space-ape-jazz-club.local'?>" class="scroll-header__logo">
                ...
                <div class="menu">
                    <button class="menu__scroll-button">
        ...
        <div class="site-nav">
            ...
            <div class="nav-backgraund">
                <video class="nav-backgraund__video" autoplay muted playsinline>
                    <source src="<?php echo get_template_directory_uri(); ?>./assets/image/menu-backgraund.mp4" type="video/mp4">
                </video>

                <div class="nav-backgraund__dim"></div>
            </div>
            ...
            <div class="site-nav__inner">
                ...
                <header class="site-nav__header">
                    <img src="<?php echo get_template_directory_uri(); ?>./assets/image/Group 9.svg" alt="" class="site-nav__logo">
                    <button class="site-nav__exit-button">
                        <svg id="Group_57" data-name="Group 57" xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64">
                ...
                <footer class="site-nav__footer">
                    <!-- <img src="<?php echo get_template_directory_uri(); ?>./assets/image/menu-logo.png" alt="Space Ape Jazz Club logo"> -->
                    <?php the_custom_logo(); ?>
                </footer>
